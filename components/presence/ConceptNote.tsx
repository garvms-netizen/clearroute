 ...
 * are ClearRoute's own, in ClearRoute's palette.
 */
export function ConceptNote({ channel }: { channel?: string }) {
  return (
    <Callout variant="project-note">
      ...
      shows how ClearRoute&rsquo;s campaign assets are designed to appear
      ...
      ClearRoute&rsquo;s own palette. ClearRoute is a fictional company created
